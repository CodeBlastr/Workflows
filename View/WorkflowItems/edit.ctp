...
$this->set('context_menu', array('menus' => array(
	array(
		...
		'items' => array(
			$this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('WorkflowItem.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('WorkflowItem.id'))),
			$this->Html->link(__('List Workflow Items', true), array('action' => 'index')),
			...
			$this->Html->link(__('New Parent Workflow Item', true), array('controller' => 'workflow_items', 'action' => 'add')),
			...
			$this->Html->link(__('List Workflow Item Events', true), array('controller' => 'workflow_item_events', 'action' => 'index')),
			$this->Html->link(__('New Workflow Item Event', true), array('controller' => 'workflow_item_events', 'action' => 'add')),
			)
		),
	)));
?>